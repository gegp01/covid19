...
#    focal<-as.vector(net1$from)[as.vector(net1$from.nom)==as.vector(input$origen1)]
  ...
  output$text3<-renderUI({
    HTML("<h3>¿Te expones al covid-19 cuando viajas?</h3><p align='justify'>Cuando nos movemos de un lugar a otro nos cruzamos con personas y materiales originarios de distintos lugares del país.
